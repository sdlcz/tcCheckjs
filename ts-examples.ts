...
test('How to type text into an input (t.typeText user action)', async (t: TestController) => {
    await t
...
test('How to click check boxes and then verify their states (t.click user action and ok() assertion)', async (t: TestController) => {
    await t
...
test('How to type text into an input, click at a specified position and backspace a symbol (t.typeText, t.click, t.pressKey user actions and eql() assertion)', async (t: TestController) => {
    await t
...
test('How to press a specified key (t.pressKey user action)', async (t: TestController) => {
    await t
        .typeText(developerName, 'Peter Parker')
...
test('How to implement comparison (ok() and notOk() assertions)', async (t: TestController) => {
...
test('How to compare a value in an input with an expected one (eql() assertion)', async (t: TestController) => {
    await t
        .typeText(developerName, 'Peter Parker')
        .click(submitButton)
...
test('How to drag a page element (t.dragToElement user action)', async (t: TestController) => {
...
test('How to hover over an element (t.hover user action)', async (t: TestController) => {
    await t
        .click(triedLabel)
...
test('How to select text in an input (t.selectText user action)', async (t: TestController) => {
    await t
...
test('How to handle a confirmation dialog (t.setNativeDialogHandler() and t.getNativeDialogHistory())', async (t: TestController) => {
    await t
...
test('A simple test on our example page', async (t: TestController) => {
